    ...
    <div className="home-page">
          ...
          <div className="services-grid">
            ...
            >
              <Card className="glass-card service-card">
                ...
                <h3 className="text-heading-2 service-title">{t('home.services.sales_title')}</h3>
            ...
            >
              <Card className="glass-card service-card">
                ...
                <h3 className="text-heading-2 service-title">{t('home.services.rental_title')}</h3>
                <p className="service-desc">
            ...
            >
              <Card className="glass-card service-card">
                ...
                <h3 className="text-heading-2 service-title">{t('home.services.production_title')}</h3>
                <p className="service-desc">
      ...
      <section className="featured-section">
        <div className="container-premium">
          ...
          >
            <h2 className="text-display section-title">{t('home.featured.title')}</h2>
      ...
      <section className="testimonials-section">
        <div className="container-premium">
          <motion.div
            ...
            className="section-header"
          >
            <h2 className="text-display section-title">{t('home.testimonials.title')}</h2>
            <p className="text-body-large section-subtitle">
