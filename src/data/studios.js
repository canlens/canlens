export const studios = [
  {
    ...
    details: [
      'Short Promotional Video (30–60 sec): 30,000 RWF',
      'Event Highlight Video + Images: Starting from 150,000 RWF'
    ],
    capacity: 10,
    size: '8m x 10m',
  },
  {
    ...
    details: [
      'Podcast Recording Only: 30,000 RWF / Hour',
      'Podcast Recording + Editing: 80,000 RWF / Episode'
    ],
    capacity: 4,
    size: '3m x 4m',
  },
  {
    ...
    details: [
      'One Image Photoshoot: 2,000 RWF',
      'Business Branding Photoshoot: Starting from 50,000 RWF'
    ],
    capacity: 8,
    size: '6m x 8m',
  },
  {
    ...
    details: [
      ...
      'Event Highlight Video Coverage',
      'Full Event Coverage: Starting from 100,000 RWF'
    ],
    capacity: 15,
    size: 'Flexible',
  },
  {
    ...
    details: [
      'Starter Package: 100,000 RWF (4 videos, edited, 20 images)',
      'Business Package: 200,000 RWF (10 videos, edited, 50 images)',
      'Premium Package: 300,000 RWF (15 videos, edited, 70 images)'
    ],
    capacity: 5,
    size: '5m x 6m',
  },
  {
    id: 'studio-6',
    name: 'Studio Rental',
    description: 'Rent our professional studio space for your own productions. Access to basic setups or fully equipped environments.',
    priceDisplay: '20,000 RWF / Hour',
    images: [
      'https://images.unsplash.com/photo-1574717024653-61fd2cf4d44d?w=1200&q=80',
    ...
    details: [
      'Studio Rental Only: 20,000 RWF / Hour',
      'Studio + Podcast Setup: 30,000 RWF / Hour'
    ],
    capacity: 15,
    size: '10m x 12m',
  },
